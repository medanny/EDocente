...
<?php
$q1="SELECT * FROM `Categorias` WHERE `id_Encuesta` = 1";
$cat=$database->query($q1);

while($cate = $cat->fetch_assoc()){
$no_catm=$cate['NombreCategoria'];
$idCate=$cate['id_Categoria'];
?>
	...
	<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-coffee"></i><?php echo $no_catm;?>
							</div>
							<div class="tools">
...
$q="SELECT * FROM `Pregunta` WHERE `Encuestas_idEncuestas` = 1 AND `id_Categoria` = $idCate";
